...
import com.chayan.toolkit.models.AlarmSound
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.chayan.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.copyToClipboard(text: String) {
    val clip = ClipData.newPlainText(getString(R.string.android_toolkit), text)
