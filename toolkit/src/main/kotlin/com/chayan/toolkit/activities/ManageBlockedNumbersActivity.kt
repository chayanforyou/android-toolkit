...
import com.chayan.toolkit.compose.screens.ManageBlockedNumbersScreen
import com.chayan.toolkit.compose.theme.AppThemeSurface
import com.chayan.toolkit.dialogs.AddOrEditBlockedNumberAlertDialog
import com.chayan.toolkit.dialogs.ExportBlockedNumbersDialog
import com.chayan.toolkit.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
        ...
        setContent {
            ...
            AppThemeSurface {
                ...
                ManageBlockedNumbersScreen(
                    ...
                    isDialer = true,
                    hasGivenPermissionToBlock = true,
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus()) setDefaultCallerIdApp()
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        super.onActivityResult(requestCode, resultCode, resultData)
        when {
            requestCode == REQUEST_CODE_SET_DEFAULT_DIALER -> {
                updateBlockedNumbers()
            }
