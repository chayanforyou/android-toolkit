...
import com.chayan.toolkit.compose.screens.*
import com.chayan.toolkit.compose.theme.AppThemeSurface
import com.chayan.toolkit.dialogs.ConfirmationAdvancedAlertDialog
...
class AboutActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            AppThemeSurface {
                ...
                val onRateUsClickAlertDialogState = getOnRateUsClickAlertDialogState()
                AboutScreen(
                    goBack = ::finish,
                    helpUsSection = {
                        ...
                        HelpUsSection(
                            onRateUsClick = onRateUsClickAlertDialogState::show,
    ...
    @Composable
    private fun getOnRateUsClickAlertDialogState() =
        rememberAlertDialogState().apply {
            DialogMember {
                ConfirmationAdvancedAlertDialog(
                    alertDialogState = this,
    ...
    private fun onFacebookClick() {
        var link = "https://www.facebook.com/chayanmistrry"
        launchViewIntent(link)
    }

    private fun onGithubClick() {
        launchViewIntent("https://github.com/chayanforyou")
    }

    private fun onRedditClick() {
        launchViewIntent("https://www.reddit.com/r/chayanforyou")
    }


    private fun onTelegramClick() {
        launchViewIntent("https://t.me/chayanforyou")
    }


    private fun onWebsiteClick() {
        launchViewIntent("https://chayanforyou.github.io")
    }
